...
1. Resolve the issue source.
   ...
   - Fetch the full issue body, labels, linked issues, comments, acceptance criteria, screenshots, and current status when the tracker is available.
